  ...
  <div id='main-content' class='clearfix'>
    <div id='content' class='clearfix'>
      <?php print render($page['content']) ?>
        ...
        <div class="media_login_box">
         <div class="media_login_inntro">
            <p>Press information and picture material on the current collections, and the company, are available for download in the Advanti Press Database.</p>
           </div>
           <div class="login_box">
